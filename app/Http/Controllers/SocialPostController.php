...
class SocialPostController extends Controller
{
  ...
  public function auto_post_action(Request $request)
  {
    ...
    try {
      ...
      $consumerKey = 'UXOjUNN1Yhv5vEEDi3Hzj8AFD';
      $consumerSecret = 'jEOcO0ZgZiKJOYlSWVBSbL7yF2RBrS60366b1gUemdHgwNTTgJ';
      $accessToken = '1355641690074345472-tZ7MqhkIJBvjwgbUhJvltzHIDq9dZ6';
      $accessTokenSecret = 'C171rau0ziKWDFcdvpqH3R6Nw7CUoTTGqk4hKZSTGvppM';
      if ($api_response) {
        $post_count = 0;
